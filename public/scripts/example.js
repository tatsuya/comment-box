...
var CommentBox = React.createClass({
  ...
  handleCommentSubmit: function(comment) {
    ...
    // Optimistically set an id on the new comment. It will be replaced by an id
    // generated by the server. In a production application you would likely not
    // use Date.now() for this and would have a more robust system in place.
    comment.id = Date.now();
...
var CommentForm = React.createClass({
  ...
  // React attached event handlers to components using a camelCase naming
